<template>
	<view>
		...
		<view class="flex align-center py-3 px-2 border-bottom justify-between">
			<view class="border rounded bg-light mx-1 px-1 animate__animated "
			hover-class="animate__jello" v-for="(item,index) in hotCate"
